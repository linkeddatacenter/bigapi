...
This document describes the <your project name> architecture and the foundational technology and environment on which it runs. It provides a base layer of processes, services, tools, and frameworks that allow developers to build, deploy, and manage applications. Essentially, **it is the main design document for <your project name>**.

## What is it good for?
This document serves as an entry point for understanding the broader context of <your project name>. It is useful for:
...
This is not a place to find detailed component development documentation. 
...
- read the definition of some [terms]() used inside the <your project name> jargon
- read the [standards]() to which <your project name> conforms
- read the [architecture overview]()
- self-assess your [skills]() 
- find the [roles]() best match your competences
- join a [process]()
```
